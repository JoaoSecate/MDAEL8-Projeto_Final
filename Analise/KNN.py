...
def main():
    ...
    plot_confusion_matrix(cm, input_file.target_names, False, "Confusion Matrix - K-NN")      
    plot_confusion_matrix(cm, input_file.target_names, True, "Confusion Matrix - K-NN normalized")  
    ...
    # Get test confusion matrix    
    cm = confusion_matrix(y_test, y_hat_test)        
    plot_confusion_matrix(cm, input_file.target_names, False, "Confusion Matrix - K-NN sklearn")      
    plot_confusion_matrix(cm, input_file.target_names, True, "Confusion Matrix - K-NN sklearn normalized" )  
    plt.show()
